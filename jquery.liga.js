...
;(function ( $, window, document, undefined ) {
    ...
    Plugin.prototype = {
        ...
        memoria : function(el, options) {
            var llave  = (typeof options == 'string') ? options : options[0];
            var valor  = ((typeof options == 'object' && options[1]) || options[1] == null) ? options[1] : undefined;
            var expira = (typeof options == 'object' && options[2]) ? options[2] : undefined;
        ...
        actualizar : function(el, options) {
            if (typeof options !== 'string') return this;
